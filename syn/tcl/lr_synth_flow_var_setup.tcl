...
set_flow_var netlist_out "./${lr_synth_out_dir}/generated/${lr_synth_top_module}_netlist_attr.v" "netlist out"
set_flow_var flattened_out "./${lr_synth_out_dir}/generated/${lr_synth_top_module}_flattened.v" "flattened"
set_flow_var netlist_noattr_out "./${lr_synth_out_dir}/generated/${lr_synth_top_module}_netlist.v" "netlist out noattr"
set_flow_var submodule_netlist_out "./${lr_synth_out_dir}/generated/${lr_synth_top_module}_submodule_netlist_attr.v" "submodule netlist out"
set_flow_var submodule_netlist_noattr_out "./${lr_synth_out_dir}/generated/${lr_synth_top_module}_submodule_netlist.v" "submodule netlist out noattr"
